          ...
          <div className="p-4 border-b border-arcane-border">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-arcane-purple/20 via-arcane-dark to-arcane-gold/10 p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-arcane-purple to-arcane-gold flex items-center justify-center text-lg font-bold text-white overflow-hidden flex-shrink-0 ring-2 ring-arcane-border">
                  {profile?.avatar_url ? (
                    <img
