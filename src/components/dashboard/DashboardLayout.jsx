  ...
  return (
    <>
      ...
      <div className="relative min-h-screen">
        {/* Background Image - Fixed and covering entire viewport */}
        <div
        ...
        <div className="relative z-10">
          ...
          <div className="flex pt-[100px]">
            ...
            <motion.aside
              className={`fixed lg:sticky top-[72px] left-0 z-40 w-64 h-[calc(100vh-72px)] bg-arcane-surface/95 backdrop-blur-md border-r border-arcane-border flex flex-col overflow-y-auto transition-transform lg:translate-x-0 ${
                sidebarOpen ? "translate-x-0" : "-translate-x-full"
              }`}
            >
              {/* User Profile Card */}
              <div className="p-4 border-b border-arcane-border">
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-arcane-purple/30 via-arcane-dark/80 to-arcane-gold/20 p-4 backdrop-blur-sm">
                  ...
                  <div className="mt-3 flex items-center justify-between p-2.5 rounded-xl bg-arcane-dark/70 backdrop-blur-sm">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
                        isActive
                          ? "bg-arcane-purple/30 text-white backdrop-blur-sm"
                          : "text-white hover:bg-arcane-border/50 hover:backdrop-blur-sm"
                      }`}
                    >
                      <item.icon
              ...
              <div className="p-3 border-t border-arcane-border">
                <button
                  ...
                  className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm text-danger hover:bg-danger/10 transition-all backdrop-blur-sm"
                >
